...
2. **Available ZBG Positions**: Checks all three protocols for any active deposits. Scans 12 HODLMM pools (the ZEST, stSTX and LEO pools are not included). If you have nothing deployed, it tells you straight: "idle, earning nothing."
...
| HODLMM Pool Contracts | User bins, bin balances, active bin, pool state | Direct pool contract reads (12 pools) |
